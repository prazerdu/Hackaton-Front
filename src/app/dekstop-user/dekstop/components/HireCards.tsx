...
const cards = [
  {
    ...
    title: "Projeto X",
    subtitle:
      "Projeto que busca crescer na área da tecnologia e gerar impacto positivo para jovens devs.",
    image:
      "https://i.pinimg.com/736x/35/31/74/3531741d5601c7ed9c1505d784db9b4b.jpg",
  },
  {
    id: 2,
    ...
    subtitle: "2 acessos",
    image:
      "https://i.pinimg.com/1200x/92/40/ef/9240ef093578c01b6f4e087ef9989b5a.jpg",
  },
  {
    id: 3,
    title: "Desafio Desktop",
    subtitle: "5 acessos",
    image:
      "https://i.pinimg.com/736x/42/27/71/42277172780abf5043438989d49856e2.jpg",
  },
  {
    id: 4,
    ...
    subtitle: "1 acesso",
    image:
      "https://i.pinimg.com/1200x/a9/fb/fe/a9fbfec81940413f28fde608c3321101.jpg",
  },
  {
    id: 5,
    ...
    subtitle: "4 acessos",
    image:
      "https://i.pinimg.com/736x/0b/b4/17/0bb41713571ad487947c810ad18c73d4.jpg",
  },
];
        ...
        {visibleCards.map((c) => (
          ...
          >
            ...
            <CardHeader className="flex flex-col items-center space-y-2 p-4">
              ...
              <CardDescription className="text-xs text-gray-500 text-center line-clamp-2">
                {c.subtitle}
              </CardDescription>
            </CardHeader>
          ...
          {selectedCard && (
            <>
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <Button
                  onClick={() => alert(`Acessando ${selectedCard.title}`)}
                >
                  Acessar
                </Button>
              </div>
