...
export default function StepUsuarios() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-pink-500 to-rose-500 p-8">
      <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 flex flex-col items-start">
          ...
          >
            Descubra como nossos usuários participam, colaboram em desafios e constroem soluções inovadoras juntos.
          </motion.p>
        </div>
        ...
        >
          <div className="relative w-full max-w-md h-80 flex items-center justify-center rounded-2xl overflow-hidden shadow-2xl bg-white/20 backdrop-blur-lg border border-white/30">
            <Image
              src="/onboarding/users.svg"
              alt="Usuários Ninna Hub"
              fill
