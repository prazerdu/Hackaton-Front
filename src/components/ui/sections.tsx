...
const defaultValues: AboutUsProps['values'] = [
  ...
  },
  {
    title: 'Colaboração',
    description:
      'Acreditamos no poder do trabalho em equipe e da diversidade para alcançar resultados extraordinários.',
    icon: 'Users',
  },
  {
    title: 'Plataforma Eficiente',
    description:
      'Nos empenhamos em oferecer serviços de alta qualidade e confiabilidade para todos os nossos parceiros.',
    icon: 'Sparkles',
  },
  {
