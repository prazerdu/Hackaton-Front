...
const defaultValues: AboutUsProps['values'] = [
    {
        ...
        description:
            'Buscamos constantemente novas ideias e tecnologias para criar soluções de ponta.',
        icon: 'Lightbulb',
    },
    {
        title: 'Usuarios',
        description:
            'Usuários participam ativamente do ciclo de inovação, submetendo ideias e colaborando conforme seu perfil de acesso',
        icon: 'Users',
    },
    {
        title: 'Plataforma Eficiente',
        description:
            'Nos empenhamos em oferecer serviços sempre de alta qualidade e confiabilidade para todos as nossas companhias parceiras',
        icon: 'Sparkles',
    },
    {
        title: 'Impacto Sustentável',
        description:
            'Medimos nosso sucesso pelo impacto positivo que geramos nas empresas e na sociedade.',
        icon: 'Globe',
    },
];
...
export default function AboutUs1() {
    const aboutData = {
        ...
        subtitle:
            'Somos uma Plataforma de Inovação Aberta Corporativa que conecta empresas a startups inovadoras para impulsionar a transformação digital e o crescimento sustentável.',
        mission:
            'Impulsionar a transformação digital e o crescimento sustentável por meio de parcerias estratégicas e inovação colaborativa.',
        vision:
            'Ser referência em inovação aberta, conectando empresas e startups para gerar soluções digitais eficientes e sustentáveis.',
